...
const BankingSection = () => {
	return (
		<section className={classes.bankingSection}>
			<div className={classes.bankingContainer}>
				<div className={classes.bankingSection__intro}>
					<h2 className={classes.bankingSection__title}>
						Why choose EasyBank?
					</h2>
				...
				<div className={classes.bankingSection__cardsContainer}>
					<ul className={classes.bankingSection__list}>
						<CardItem
							src={online}
